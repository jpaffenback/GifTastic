...
var topics =["Cats", "Dogs", "Pigs", "Horses", "Goats", "Fish", "Frogs", "Unicorns", "Lizard", "Dragons", "Puffin"];



//makes buttons out of array
...
function searchGif(gifName) {
    $.ajax({
            url: 'https://api.giphy.com/v1/gifs/search?q= ' + gifName + '&api_key=0YT9ThrVi8c25htvrkh2akkDCNu0che9&limit=10',
            type: 'GET',
        })
